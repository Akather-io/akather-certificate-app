...
import {
  ICertificate,
  ITokenMetadata,
} from "../app/my-certificate/certificate.type";
...
export class NftCertificateNEAR {
  ...
  nft_mint(user: string, tokenId?: string) {
    ...
    const newMetadata: ITokenMetadata = {
      ...
      description:
        "has successfully completed the Surgical Skill program by Akather",
      media:
        "https://bafybeifcqlnqvgefmrnxpe7lf4p4tv2y3dl25l67ka3onsakqmd2ch4ksq.ipfs.dweb.link",
      issued_at: time,
      extra: JSON.stringify({ issued_by: "Akather" }),
    };
